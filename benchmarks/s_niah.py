...
def generate_haystack(file_path: Path, size_in_tokens: int = 100000):
    """
...
def run_test():
    haystack_file = BASE_DIR / "data" / "haystack.txt"
    ...
    db_path = BASE_DIR / "data" / "s_niah.db"
    ...
    indexer.ingest_file(str(haystack_file), max_chunk_tokens=25000, group_size=2)
